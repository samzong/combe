(() => {
  const metrics = [
    ...
    {"id": "S02", "group": "sidebar", "label": "Header → first repo heading", "native": "8", "proposal": "8", "geometry": {"type": "gap", "a": ".menu-header", "ae": "B", "b": ".group-head", "be": "T"}, "note": "This is the catalog top padding, not an extra header-to-catalog gap.", "source": "sidebar_panel.rs:rebuild"},
    ...
    {"id": "S11", "group": "sidebar", "label": "Repo heading → first workspace row", "native": "2", "proposal": "Keep2 as dense-list exception", "geometry": {"type": "gap", "a": ".group-head", "ae": "B", "b": ".group .row", "be": "T"}, "note": "Heading height30 is a size; this2pt is an actual gap.", "source": "sidebar_panel.rs:rebuild"},
