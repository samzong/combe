(() => {
  const metrics = [
    ...
    {"id": "W02", "group": "window", "label": "Glass → first tab", "native": "12", "proposal": "12", "geometry": {"type": "gap", "a": ".platter", "ae": "R", "b": ".tab", "be": "L"}, "note": "The header and tabs stay in place in all sidebar states. Measured at the start of the tab scroll range.", "source": "window.rs:layout_chrome"},
    {"id": "W03", "group": "window", "label": "Glass → terminal area, pinned", "native": "12", "proposal": "12", "geometry": {"type": "gap", "a": ".platter", "ae": "R", "b": ".term", "be": "L"}, "note": "In transient mode the panel overlaps the terminal; a negative measurement means overlap.", "source": "window.rs:layout_chrome"},
    ...
    {"id": "W05", "group": "window", "label": "Tab row allocation → terminal area", "native": "0", "proposal": "0", "geometry": {"type": "gap", "a": ".tabs", "ae": "B", "b": ".term", "be": "T"}, "note": "60pt is the top row allocation; there is no extra gap after it.", "source": "window.rs:layout_chrome"},
    ...
    {"id": "W07", "group": "window", "label": "Window and sidebar corner radii", "native": "34 window / 18 sidebar; fullscreen 0 window", "proposal": "Keep", "geometry": {"type": "info", "selector": ".platter"}, "note": "Radii are shape geometry, not empty-space tokens.", "source": "window.rs:WINDOW_RADIUS; sidebar_panel.rs:SIDEBAR_RADIUS"},
    {"id": "H01", "group": "header", "label": "First traffic light → window", "native": {"T": "30 − system button height / 2", "L": "20"}, "proposal": "Shared header center 30", "geometry": {"type": "inset", "outer": "#win", "inner": ".traffic i:first-child", "mask": "TL"}, "note": "Native and prototype traffic lights share the header center at 30pt. AppKit owns the native button size; the prototype uses a 12px circle at y24.", "source": "window.rs:layout_chrome"},
    ...
    {"id": "H09", "group": "header", "label": "Workspace trigger → Add button", "native": "2", "proposal": "Keep 2", "geometry": {"type": "gap", "a": "#trigger", "ae": "R", "b": "#add", "be": "L"}, "note": "Prototype is currently 0 because its trigger is 2px wider.", "source": "sidebar_panel.rs:layout"},
    ...
    {"id": "H11", "group": "header", "label": "Add button → Pin button", "native": "4", "proposal": "Keep4", "geometry": {"type": "gap", "a": "#add", "ae": "R", "b": "#pin", "be": "L"}, "note": "Both boxes are28 ×28. The native trigger-to-Add gap remains2; the prototype remains0.", "source": "sidebar_panel.rs:layout"},
    {"id": "H12", "group": "header", "label": "Add button → header top / bottom", "native": {"T": "4", "B": "4"}, "proposal": "4", "geometry": {"type": "inset", "outer": ".menu-header", "inner": "#add", "mask": "TB"}, "note": "Vertical centering is (36 − 28) / 2.", "source": "sidebar_panel.rs:layout"},
    {"id": "H13", "group": "header", "label": "Pin button → header top / right / bottom", "native": {"T": "4", "R": "4", "B": "4"}, "proposal": "Keep T4 R4 B4", "geometry": {"type": "inset", "outer": ".menu-header", "inner": "#pin", "mask": "TRB"}, "note": "The right inset shares H18. Top and bottom are relative to the36pt header.", "source": "sidebar_panel.rs:layout"},
    {"id": "H14", "group": "header", "label": "Add symbol → its button", "native": {"T": "System", "R": "System", "B": "System", "L": "System"}, "proposal": "Keep AppKit symbol layout", "geometry": {"type": "inset", "outer": "#add", "inner": "#add svg", "mask": "TRBL"}, "note": "Only the prototype fixes SVG size at15px, centered in28px. Native SF Symbol ink/padding are system-owned.", "source": "chrome_view.rs:icon_button"},
    {"id": "H15", "group": "header", "label": "Pin symbol → its button", "native": {"T": "System", "R": "System", "B": "System", "L": "System"}, "proposal": "Keep AppKit symbol layout", "geometry": {"type": "inset", "outer": "#pin", "inner": "#pin svg", "mask": "TRBL"}, "note": "The prototype has 6.5px box insets. This is not a measured native glyph inset.", "source": "chrome_view.rs:icon_button"},
    {"id": "H16", "group": "header", "label": "Header and tool hit-target sizes", "native": {"X": "28 tool", "Y": "36 header / 28 tool"}, "proposal": "Keep sizes", "geometry": {"type": "size", "selector": "#pin"}, "note": "Geometry, not spacing. Text, icon, hit target, and glass have different boundaries.", "source": "sidebar_panel.rs:TAB_HEIGHT,TOGGLE_WIDTH,TOGGLE_HEIGHT"},
    {"id": "H17", "group": "header", "label": "Add button → whole glass", "native": {"T": "4", "R": "36", "B": "G − 32", "L": "sidebar − 64 open; sidebar − 136 closed"}, "proposal": "T4 R36 B(G−32); left derived", "geometry": {"type": "inset", "outer": ".platter", "inner": "#add", "mask": "TRBL"}, "note": "G is actual glass height:36 closed,36 + capped catalog height transient, H−24 pinned. Normal window, default300pt sidebar; text uses native full frame, not short glyph ink. Bottom is free panel space, not header padding.", "source": "sidebar_panel.rs:layout"},
    ...
    {"id": "T01", "group": "tabs", "label": "Tab → top row top / bottom", "native": {"T": "12", "B": "12"}, "proposal": "12", "geometry": {"type": "inset", "outer": ".tabs", "inner": ".tab", "mask": "TB"}, "note": "Top row60, tab36. This already accounts for the 12px space below the tab.", "source": "tab_bar.rs:TabBar::update"},
    {"id": "T02", "group": "tabs", "label": "Tab size", "native": {"X": "180", "Y": "36"}, "proposal": "Keep", "geometry": {"type": "size", "selector": ".tab"}, "note": "Nominal size, not padding.", "source": "tab_bar.rs:WIDTH,HEIGHT"},
    {"id": "T03", "group": "tabs", "label": "Tab → next tab", "native": "12", "proposal": "12", "geometry": {"type": "gap", "a": ".tab:first-child", "ae": "R", "b": ".tab:nth-child(2)", "be": "L"}, "note": "Repeats for every adjacent tab; shown when there are at least two tabs.", "source": "tab_bar.rs:TabBar::update"},
    {"id": "T04", "group": "tabs", "label": "Last tab → New tab button", "native": "12", "proposal": "12", "geometry": {"type": "gap", "a": ".tab:last-of-type", "ae": "R", "b": ".newtab", "be": "L"}, "note": "Same spacing definition as the tab-to-tab gap.", "source": "tab_bar.rs:TabBar::update"},
    {"id": "T05", "group": "tabs", "label": "Title text frame → tab", "native": {"T": "9", "R": "38", "B": "9", "L": "12"}, "proposal": "Keep 38 right reservation", "geometry": {"type": "inset", "outer": ".tab", "inner": ".tab .label", "mask": "TRBL"}, "note": "Native maximum label frame130 ×18. Close visibility does not move the label.", "source": "tab_bar.rs:TabBar::update"},
    {"id": "T06", "group": "tabs", "label": "Close hit target → tab", "native": {"T": "8", "R": "10", "B": "8", "L": "150"}, "proposal": "20 pt target, right10", "geometry": {"type": "inset", "outer": ".tab", "inner": ".tab .x", "mask": "TRBL"}, "note": "Close appears on tab hover or keyboard focus. Target and circular background are20 ×20.", "source": "tab_bar.rs:TabBar::update"},
    {"id": "T07", "group": "tabs", "label": "Title text frame → Close hit target", "native": "8", "proposal": "8", "geometry": {"type": "gap", "a": ".tab .label", "ae": "R", "b": ".tab .x", "be": "L"}, "note": "Maximum native title frame ends8pt before the close target.", "source": "tab_bar.rs:TabBar::update"},
    {"id": "T08", "group": "tabs", "label": "Close glyph line frame → Close hit target", "native": "AppKit centers the glyph", "proposal": "Keep native glyph alignment", "geometry": {"type": "info", "selector": ".tab .x"}, "note": "Native NSButton centers an SF Symbol inside a20 ×20 target.", "source": "chrome_view.rs:ActionButton::new"},
    {"id": "T09", "group": "tabs", "label": "New tab hit target", "native": {"X": "36", "Y": "36"}, "proposal": "Keep", "geometry": {"type": "size", "selector": ".newtab"}, "note": "Native target36 ×36 with a centered28pt circular hover background.", "source": "tab_bar.rs:TabBar::update"},
    {"id": "T10", "group": "tabs", "label": "New tab button → window right edge", "native": "Flexible; right viewport inset12", "proposal": "Keep flexible", "geometry": {"type": "gap", "a": ".newtab", "ae": "R", "b": "#win", "be": "R"}, "note": "This is unused tab capacity, not a fixed margin. Overflow scrolls.", "source": "tab_bar.rs:TabBar::update; window.rs:layout_chrome"},
    {"id": "S01", "group": "sidebar", "label": "Catalog viewport → glass", "native": {"T": "36", "R": "0", "B": "0 pinned", "L": "0"}, "proposal": "Keep", "geometry": {"type": "inset", "outer": ".platter", "inner": "#catalog", "mask": "TRBL"}, "note": "The native viewport fills the area under the36pt header. HTML catalog has content height with a max-height; its empty pinned remainder differs.", "source": "sidebar_panel.rs:layout"},
    {"id": "S02", "group": "sidebar", "label": "Header → first catalog row", "native": "8", "proposal": "8", "geometry": {"type": "gap", "a": ".menu-header", "ae": "B", "b": ".row", "be": "T"}, "note": "This is the catalog top padding, not an extra header-to-catalog gap. Home is the first catalog row and has no repo heading.", "source": "sidebar_panel.rs:rebuild"},
    {"id": "S03", "group": "sidebar", "label": "Catalog content padding", "native": {"T": "8", "R": "6", "B": "12", "L": "6"}, "proposal": "Keep T 8 / R 6 / B 12 / L 6", "geometry": {"type": "padding", "selector": "#catalog"}, "note": "The12pt bottom is minimum natural content padding. Additional pinned empty space is flexible.", "source": "sidebar_panel.rs:rebuild"},
    {"id": "S04", "group": "sidebar", "label": "Last workspace row → next repo heading", "native": "16.5 = 8 + 0.5 + 8", "proposal": "Keep 8 / hairline / 8", "geometry": {"type": "gap", "a": ".group:first-child .row:last-child", "ae": "B", "b": ".group:nth-child(2) .group-head", "be": "T"}, "note": "Browser measurement confirms16.5 after margin collapse. The same group separator pattern repeats.", "source": "sidebar_panel.rs:rebuild"},
    {"id": "S05", "group": "sidebar", "label": "Repo heading → catalog sides", "native": {"R": "6", "L": "6"}, "proposal": "Keep R 6 / L 6", "geometry": {"type": "inset", "outer": "#catalog", "inner": ".group-head", "mask": "RL"}, "note": "Shares S03; do not add both values when computing the same edge.", "source": "sidebar_panel.rs:rebuild"},
    {"id": "S06", "group": "sidebar", "label": "Repo heading text frame → heading", "native": {"T": "6", "R": "28", "B": "6", "L": "34"}, "proposal": "Keep current text and arrow frames", "geometry": {"type": "inset", "outer": ".group-head", "inner": ".group-head > span", "mask": "TRBL"}, "note": "Native30pt heading with18pt label frame. Prototype text span is intrinsic-width.", "source": "sidebar_panel.rs:rebuild; chrome_view.rs:194–202"},
    {"id": "S07", "group": "sidebar", "label": "Folder icon → heading", "native": {"T": "8", "B": "8", "L": "12"}, "proposal": "Keep", "geometry": {"type": "inset", "outer": ".group-head", "inner": ".group-head > svg:first-child", "mask": "TBL"}, "note": "14 ×14 icon box; native and prototype agree.", "source": "sidebar_panel.rs:rebuild"},
    {"id": "S08", "group": "sidebar", "label": "Folder icon → repo title", "native": "8", "proposal": "8", "geometry": {"type": "gap", "a": ".group-head > svg:first-child", "ae": "R", "b": ".group-head > span", "be": "L"}, "note": "This8pt gap is distinct from the12pt leading inset.", "source": "sidebar_panel.rs:rebuild"},
    {"id": "S09", "group": "sidebar", "label": "Repo disclosure arrow → heading", "native": {"T": "10", "R": "16", "B": "10"}, "proposal": "Keep T 10 / R 16 / B 10", "geometry": {"type": "inset", "outer": ".group-head", "inner": ".group-head .arrow", "mask": "TRB"}, "note": "Native10 ×10 arrow sits4pt farther left than the prototype.", "source": "sidebar_panel.rs:rebuild"},
    {"id": "S10", "group": "sidebar", "label": "Repo text frame → disclosure arrow", "native": "2", "proposal": "Keep 2", "geometry": {"type": "gap", "a": ".group-head > span", "ae": "R", "b": ".group-head .arrow", "be": "L"}, "note": "Native text-frame gap2; prototype gap includes elastic short-text space.", "source": "sidebar_panel.rs:rebuild"},
    {"id": "S11", "group": "sidebar", "label": "Repo heading → first workspace row", "native": "2", "proposal": "Keep2 as dense-list exception", "geometry": {"type": "gap", "a": ".group:nth-child(2) .group-head", "ae": "B", "b": ".group:nth-child(2) .row", "be": "T"}, "note": "Heading height30 is a size; this2pt is an actual gap. Measured on the first repo group; Home has no heading.", "source": "sidebar_panel.rs:rebuild"},
    {"id": "S12", "group": "sidebar", "label": "Workspace row → next workspace row", "native": "2", "proposal": "Keep2 as dense-list exception", "geometry": {"type": "gap", "a": ".group:nth-child(2) .row:first-child", "ae": "B", "b": ".group:nth-child(2) .row:nth-child(2)", "be": "T"}, "note": "Visible row34, stride36. The same relation applies to all adjacent rows.", "source": "sidebar_panel.rs:rebuild"},
    {"id": "S13", "group": "sidebar", "label": "Workspace row → catalog sides", "native": {"R": "6", "L": "6"}, "proposal": "Keep R 6 / L 6", "geometry": {"type": "inset", "outer": "#catalog", "inner": ".row", "mask": "RL"}, "note": "Shares S03. Selected background and row hit target use this same outer box.", "source": "sidebar_panel.rs:rebuild"},
    ...
    {"id": "S16", "group": "sidebar", "label": "Session dot → workspace text", "native": "10", "proposal": "Keep 10", "geometry": {"type": "gap", "a": ".row .dot", "ae": "R", "b": ".row .label", "be": "L"}, "note": "Reducing the gap changes text indentation. Dot position remains32.", "source": "chrome_view.rs:70–78; sidebar_panel.rs:rebuild"},
    ...
    {"id": "S19", "group": "sidebar", "label": "Workspace text frame → marker", "native": "7", "proposal": "Keep 7", "geometry": {"type": "gap", "a": ".row .label", "ae": "R", "b": ".row .shortcut", "be": "L"}, "note": "Fixed native full-label-frame gap; prototype short-label free space varies.", "source": "chrome_view.rs:88–99; sidebar_panel.rs:rebuild"},
    {"id": "S20", "group": "sidebar", "label": "Last row → glass bottom", "native": "12 + flexible remainder, pinned", "proposal": "Keep flexible; do not force uniform12", "geometry": {"type": "gap", "a": ".group:last-child .row:last-child", "ae": "B", "b": ".platter", "be": "B"}, "note": "A pinned sidebar fills the window; its catalog does not have to fill the height. Assumes unscrolled content without overflow; scrolling can make this distance negative.", "source": "sidebar_panel.rs:layout,rebuild"},
    {"id": "S21", "group": "sidebar", "label": "Separator edges and focus outline", "native": "Separator L6/R6, stroke0.5; focus inset2, stroke2", "proposal": "Separator edges follow S03; keep focus visible", "geometry": {"type": "info", "selector": ".group:nth-child(2)"}, "note": "Hairlines and focus rings are drawing geometry, not content padding.", "source": "sidebar_panel.rs:SidebarView::draw_rect; chrome_view.rs:58–64"},
    {"id": "S22", "group": "sidebar", "label": "Resize hit strip → glass", "native": {"T": "−12 pinned", "R": "−4", "B": "−12 pinned", "L": "sidebar width"}, "proposal": "Keep exposed4pt strip", "geometry": {"type": "inset", "outer": ".platter", "inner": ".sidebar-resize", "mask": "TRBL"}, "note": "Native hit strip spans the whole root split height, subject to covering views. Negative insets extend beyond glass. Prototype excludes44px at top and16px at bottom.", "source": "window.rs:SplitDelegate::divider_grab"},
    ...
    {"id": "E02", "group": "terminal", "label": "Tab bottom → terminal surface top", "native": "12", "proposal": "12", "geometry": {"type": "gap", "a": ".tab", "ae": "B", "b": ".pane", "be": "T"}, "note": "Ends at the surface edge. E03 additionally includes the terminal inner padding.", "source": "tab_bar.rs:TabBar::update; window.rs:layout_chrome"},
    {"id": "E03", "group": "terminal", "label": "Tab bottom → first text line box", "native": "20 + grid remainder", "proposal": "20 + grid remainder", "geometry": {"type": "contentGap", "a": ".tab", "ae": "B", "b": ".pane", "be": "T"}, "note": "Includes the12pt gap below the tab plus8pt surface padding. Glyph ink sits inside a line box.", "source": "tab_bar.rs:TabBar::update; habits.rs:35–37"},
    {"id": "E04", "group": "terminal", "label": "Pinned glass right → text area left", "native": "20 + grid remainder", "proposal": "20 + grid remainder", "geometry": {"type": "contentGap", "a": ".platter", "ae": "R", "b": ".pane", "be": "L"}, "note": "12pt outer gap plus8pt inner padding. In transient mode the glass overlays the terminal.", "source": "window.rs:layout_chrome; habits.rs:35–37"},
    {"id": "E05", "group": "terminal", "label": "Last pane text area → window right", "native": "20 + grid remainder", "proposal": "20 + grid remainder", "geometry": {"type": "contentGap", "a": ".pane:last-child", "ae": "R", "b": "#win", "be": "R", "contentA": true}, "note": "12pt outer gap plus the final pane's8pt inner padding.", "source": "window.rs:layout_chrome; habits.rs:35–37"},
    ...
    {"id": "P04", "group": "terminal", "label": "No quota: surface → window bottom", "native": "12", "proposal": "Keep12; align prototype", "geometry": {"type": "info", "selector": ".term"}, "note": "In the current No quota snapshot scene, the prototype leaves0 outside the surface. This is a recorded mismatch, not an applied change.", "source": "window.rs:layout_chrome"},
    ...
    {"id": "F11", "group": "find", "label": "Find action glyph line frame", "native": "Centered12pt SF Symbol", "proposal": "Keep Centered12pt SF Symbol", "geometry": {"type": "info", "selector": ".find-bar button"}, "note": "Text-frame insets are separate from the22 ×38 target. Prototype browser defaults differ.", "source": "find_bar.rs:165–175; chrome_view.rs:194–202"},
    ...
    {"id": "A02", "group": "system", "label": "Directory picker internals", "native": "AppKit NSOpenPanel owns layout", "proposal": "Keep system layout", "geometry": {"type": "info", "selector": "#add"}, "note": "The prototype toast is only a placeholder; it is not the native picker layout.", "source": "sidebar_panel.rs:add_repo"},
    {"id": "A03", "group": "system", "label": "Menu items / menu margins / traffic-light ink", "native": "AppKit owns internal geometry", "proposal": "Keep system layout", "geometry": {"type": "info", "selector": ".traffic"}, "note": "Native menus, tooltips and system control glyphs do not have Combe spacing constants.", "source": "menu.rs:install; chrome_view.rs:icon_button"},
    {"id": "R01", "group": "radii", "label": "Window content clip", "native": "34; 0 in fullscreen", "proposal": "Keep34 / fullscreen0", "geometry": {"type": "radius", "selector": "#win"}, "note": "Native custom content clipping, not a replacement for system window controls. The prototype right-side wrapper inherits34 but paints no separate rounded surface.", "source": "window.rs:WINDOW_RADIUS,open,layout_chrome"},
    {"id": "R02", "group": "radii", "label": "Sidebar glass: chip / transient / pinned", "native": "18", "proposal": "Keep18 in all three states", "geometry": {"type": "radius", "selector": ".platter"}, "note": "The outer sidebar layer and material use the same radius. A36pt chip is a capsule; expansion keeps its corner radius.", "source": "sidebar_panel.rs:SIDEBAR_RADIUS,mount"},
    {"id": "R03", "group": "radii", "label": "Workspace trigger background", "native": "No independent fill", "proposal": "Keep no independent fill", "geometry": {"type": "radius", "selector": "#trigger"}, "note": "Native hover highlight is disabled. CSS18 is a transparent button shape, not a second visible glass surface. Focus is listed under R17.", "source": "sidebar_panel.rs:mount"},
    {"id": "R04", "group": "radii", "label": "Repo-heading highlight", "native": "Requested16; rx16 / ry15 at height30", "proposal": "Keep current shape", "geometry": {"type": "radius", "selector": ".group-head", "catalog": true}, "note": "AppKit limits the two arc axes independently; the uniform CSS16 corners scale to15 at height30. This is a current renderer difference, not two design tokens.", "source": "chrome_view.rs:13,43–53; sidebar_panel.rs:rebuild"},
    {"id": "R05", "group": "radii", "label": "Workspace-row selected / hover fill", "native": "16", "proposal": "Keep16", "geometry": {"type": "radius", "selector": ".row", "catalog": true}, "note": "Rows are34pt high. Selection and hover share this path. HTML uses the radius-row16 token for both list rows and repo headings.", "source": "chrome_view.rs:13,43–53; sidebar_panel.rs:rebuild"},
    {"id": "R06", "group": "radii", "label": "Active-tab glass", "native": "18", "proposal": "Keep18", "geometry": {"type": "radius", "selector": ".tab.on"}, "note": "Only the active native tab has this glass sibling. It is not the same layer as the hover highlight.", "source": "tab_bar.rs:TabBar::update"},
    {"id": "R07", "group": "radii", "label": "Tab hover highlight", "native": "18", "proposal": "Keep18 with active-tab glass", "geometry": {"type": "radius", "selector": ".tab"}, "note": "Tab titles set their ClickView radius to18, matching the glass. Other ClickViews retain16.", "source": "chrome_view.rs:43–53; tab_bar.rs:TabBar::update"},
    {"id": "R08", "group": "radii", "label": "Tab Close target background", "native": "10", "proposal": "Circle, diameter20", "geometry": {"type": "radius", "selector": ".tab .x"}, "note": "Close background is a20pt circle, visible only during interaction.", "source": "chrome_view.rs:ActionButton::draw_rect"},
    {"id": "R09", "group": "radii", "label": "New-tab target background", "native": "14", "proposal": "Circle, diameter28", "geometry": {"type": "radius", "selector": ".newtab"}, "note": "The36pt target contains a centered28pt circular background.", "source": "chrome_view.rs:ActionButton::draw_rect"},
    {"id": "R10", "group": "radii", "label": "Add / Pin button shape", "native": "14", "proposal": "Circle, diameter28", "geometry": {"type": "radius", "selector": "#pin"}, "note": "Add and pin share the circular button background.", "source": "chrome_view.rs:ActionButton::draw_rect"},
    ...
    {"id": "R20", "group": "radii", "label": "Traffic lights", "native": "AppKit owns the shape", "proposal": "Keep system controls", "geometry": {"type": "radius", "selector": ".traffic i"}, "note": "The HTML12×12 circle resolves to radius6. It is not a fixed Combe system-button radius.", "source": "window.rs:layout_chrome"},
    ...
    {"id": "R23", "group": "radii", "label": "Picker / menus / scrollbars / symbol curves", "native": "AppKit owns internal geometry", "proposal": "Keep system ownership", "geometry": {"type": "info", "selector": "#win", "text": "Not numerically simulated"}, "note": "NSOpenPanel, menu items, native scrollbars and SF Symbol ink have no Combe radius token. Text glyph curves, including the selected checkmark, are not rounded component backgrounds.", "source": "menu.rs:install; sidebar_panel.rs:add_repo; chrome_view.rs:icon_button"},
